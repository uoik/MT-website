...
<!--  -->
  <div class="m-life">
      ...
      <el-row>
          <ul class="nav">
            <li><router-link to='/' class="takeout">美团外卖</router-link></li>
            <li><router-link to='/'>猫眼电影</router-link></li>
            <li><router-link to='/' class="takeout">美团酒店</router-link></li>
            <li><router-link to='/'>民宿/公寓</router-link></li>
            <li><router-link to='/' class="takeout">商家入驻</router-link></li>
          ...
          <el-col :span='6'>
              <div class="m-life-login">
                  ...
                  <p class="m-life-login-name">Hi！{{ $store.state.userName ? $store.state.userName : '你好' }}</p>
                    <router-link v-if="!$store.state.userName" :to="{ name: 'register' }"><el-button round>注册</el-button></router-link>
                    <router-link v-if="!$store.state.userName" :to="{ name: 'login' }"><el-button round>立即登陆</el-button></router-link>
              </div>
          </el-col>
      </el-row>
    <!-- 第三行 图片 -->
